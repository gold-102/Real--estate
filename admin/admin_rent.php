<?php
    ...
    $q = "INSERT INTO rent_house(price, detail, image, category) VALUES ('$price', '$detail', '$name', 
    '$category')";
...
<div class="container my-5 bg-light">
    <h1 class="text-center text-uppercase py-3">upload in rental section</h1>
    <div class="row py-5">


    <div class="col-8 mx-auto">
    <form action="admin_rent.php" method="post" enctype="multipart/form-data">
...
<div class="table-responsive">
    ...
    <tbody>
    <?php 
    $q = mysqli_query($db, "SELECT * FROM rent_house ORDER BY id DESC");
    $n = mysqli_num_rows($q);
    if($n>0) {
    ...
    <td class="text-center"><a href="delete_rent.php?d=<?php echo $r['id'] ?>"><i class="fa fa-trash" aria-hidden="true" style="font-size:2rem;">
    </i></a></td>
    </tr>
    <?php
        }
