...
<div class="container my-5 bg-light">
    <h1 class="text-center text-uppercase py-3">bookings of buying homes</h1>
    <div class="row py-5">
...
$q = mysqli_query($db, "SELECT * FROM booking_one ORDER BY id DESC");
$n = mysqli_num_rows($q);
if($n>0) {
    ...
    $q1 = mysqli_query($db, "SELECT * FROM buy_house WHERE id = '$p_id'");
