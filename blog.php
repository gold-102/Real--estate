           ...
           <div class="row">
            ...
            <!--blog section-->
               <div class="col-md-8 my-5">
                ...
                <a href="show_blog.php?ref=<?php echo $blog['id']; ?>">
                <h6 class="lead text-uppercase"><?php echo $blog['title']; ?></h6>
                </a>
                <p></p>
                <p class="text-justify"><?php echo substr($blog['desc_blog'],0,250); ?><</p>
                </div>
            </div>
            </div>
            <!--end of upload blog section-->
               ...
               <div class="col-md-4 my-5">
                <p class="text-left text-uppercase">most shared blogs</p>
                <div>
                <a href="show_blog.php?ref=<?php echo $blog['id']; ?>">
                <h5 class="text-uppercase"><?php echo $blog['title']; ?></h5>
                </a>
