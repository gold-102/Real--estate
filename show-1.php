...
$query1 = mysqli_query($db, "SELECT * FROM rent_house WHERE id = '$ref'");
...
?>
    ...
    <form action="inserter.php?get_id=<?php echo $home_id; ?>" method="post">
...
//     $qbb = "INSERT INTO booking_two(user_id, booking, home_id) VALUES 
//     ('$user_id', '$booking', '$home_id')";

//     print_r(mysqli_query($db, $qbb));
